...
namespace WAPWrapper
{
    ...
    /// </summary>
    public class GalleryOperation : IDisposable
    {
        ...
        private VMM GalleryInstance { get; set; }
        
        /// <summary>
        /// Instantiates VMOperation
        /// </summary>
        public GalleryOperation()
        {
        ...
        public void GetGalleryContextForAdmin(string wapAdminEndpoint, string userRoleName, string adminHeaderValue)
        {
            ...
            GalleryInstance = SPF.GetGalleryContextForAdmin(VMMAdminUserRoleName);
        }
        ...
        /// </summary>
        /// <param name="subscriptionID"></param>
        public void GetGalleryContextForTenant(string wapTenantEndpoint, string tenantUsername, string subscriptionID, string tenantHeaderValue)
        {
        ...
        {
            return GalleryInstance.g.Virtu.Clouds;
        }
